...
View::View()
{
	...
	m_ViewMatrix = core::Matrix4x4::Translation(core::Vector3f(0, 0, 0.9f));
}

View::View(core::Vector2f a_Position)
{
	m_WorldPosition = a_Position;
	m_ViewMatrix = core::Matrix4x4::Translation(core::Vector3f(m_WorldPosition.x, m_WorldPosition.y, 0.0f));
}
